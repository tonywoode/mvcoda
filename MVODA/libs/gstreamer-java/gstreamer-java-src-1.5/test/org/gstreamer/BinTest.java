 ...
 *
 * moduleExamples.gstreamer-java is free software: you can redistribute it and/or modify
 * it under the terms of the GNU Lesser General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * moduleExamples.gstreamer-java is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 * GNU Lesser General Public License for more details.
 *
 * You should have received a copy of the GNU Lesser General Public License
 * along with moduleExamples.gstreamer-java.  If not, see <http://www.gnu.org/licenses/>.
 */
...
public class BinTest {    
    ...
    public void addSelf() {
        Bin bin = new Bin("");
        // Enable the line below once we know how to avoid moduleExamples.gstreamer spitting out warnings
        //assertFalse("Should not be able to add bin to itself", bin.add(bin));
        bin.dispose();
    }
    // This test doesn't work correctly on older moduleExamples.gstreamer?
    //@Test 
